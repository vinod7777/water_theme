...
const HeroSection = () => {
    ...
    return (<section id="hero-section" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <motion.div className="absolute inset-0 z-[2] flex flex-col items-center justify-center bg-background" initial={{ opacity: 1 }} animate={{ opacity: videoLoaded ? 0 : 1 }} transition={{ duration: 0.6, ease: "easeOut" }} style={{ pointerEvents: videoLoaded ? "none" : "auto" }}>
          {/* Background image with blur */}
          <img src={heroFallback} alt="" className="absolute inset-0 w-full h-full object-cover blur-md scale-105 opacity-40" aria-hidden="true"/>
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            {/* Animated logo/text */}
            <motion.div className="text-4xl md:text-6xl font-display font-black tracking-[0.3em] text-transparent bg-clip-text" style={{
            ...
            <div className="relative">
              <motion.div className="w-16 h-16 rounded-full border-4 border-primary/20" style={{ borderTopColor: 'hsl(195, 100%, 50%)' }} animate={{ rotate: 360 }} transition={{ duration: 1, repeat: Infinity, ease: "linear" }}/>
              {/* Inner pulse */}
              <motion.div className="absolute inset-2 rounded-full bg-primary/20" animate={{ scale: [0.8, 1.2, 0.8], opacity: [0.3, 0.6, 0.3] }} transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }}/>
            </div>
            
            {/* Loading text */}
            <motion.p className="text-sm font-display uppercase tracking-widest text-muted-foreground" animate={{ opacity: [0.5, 1, 0.5] }} transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }}>
              Loading Experience...
            </motion.p>
          </div>
          
          {/* Shimmer effect */}
          <motion.div className="absolute inset-0 bg-gradient-to-r from-transparent via-primary/5 to-transparent" animate={{ x: ["-100%", "100%"] }} transition={{ duration: 2, repeat: Infinity, ease: "linear" }}/>
        </motion.div>
        ...
        {needsInteraction && (<button type="button" onClick={handlePlayClick} className="absolute bottom-6 right-6 z-20 rounded-full border border-primary/40 bg-card/70 px-4 py-2 text-sm font-display uppercase tracking-widest text-foreground backdrop-blur hover:bg-card/80 transition">
            Tap to play
          </button>)}
        ...
        {[...Array(5)].map((_, i) => (<motion.div key={`streak-${i}`} className="absolute bottom-0 w-32 h-[60vh]" style={{
                left: `${10 + i * 20}%`,
      ...
      {!videoLoaded && (<div className="absolute inset-0 z-[1]">
          <motion.div className="absolute inset-0" style={{
      ...
      <motion.div className="absolute bottom-0 left-0 right-0 h-[500px]" style={{
      ...
      <motion.div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full blur-3xl will-animate" style={{
      ...
      <motion.div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full blur-3xl will-animate" style={{
      ...
      <motion.div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full blur-3xl will-animate" style={{
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        {/* Badge */}
        <motion.div initial={{ opacity: 0, y: -30, scale: 0.8 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.6, type: "spring" }} className="mt-4 md:mt-6 mb-8">
          <motion.span className="inline-flex items-center gap-3 bg-gradient-to-r from-primary/20 via-secondary/20 to-primary/20 border border-primary/50 rounded-full px-6 py-3 text-sm md:text-base font-display uppercase tracking-wider text-primary backdrop-blur-sm" animate={{
            boxShadow: [
            ...
            <motion.span animate={{ rotate: [360, 0] }} transition={{ duration: 3, repeat: Infinity, ease: "linear" }}>
              <Droplets className="w-5 h-5"/>
            </motion.span>
          </motion.span>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1, delay: 0.2, type: "spring" }} className="mb-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="mb-8 relative inline-block">
          <motion.h2 className="text-3xl md:text-5xl font-display font-black tracking-[0.4em] text-transparent bg-clip-text" style={{
          ...
          <motion.div className="absolute -bottom-2 left-0 right-0 h-1 rounded-full" style={{
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="mb-6">
          <motion.p className="text-xl md:text-3xl font-display uppercase tracking-widest font-bold" style={{
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }} className="mb-8">
          <p className="text-lg md:text-xl text-muted-foreground font-display">
            <motion.span className="text-primary font-bold" animate={{ opacity: [0.7, 1, 0.7] }} transition={{ duration: 1.5, repeat: Infinity }}>
              Dream
            </motion.span>
            {" • "}
            <motion.span className="text-accent font-bold" animate={{ opacity: [0.7, 1, 0.7] }} transition={{ duration: 1.5, repeat: Infinity, delay: 0.3 }}>
              Code
            </motion.span>
            {" • "}
            <motion.span className="text-secondary font-bold" animate={{ opacity: [0.7, 1, 0.7] }} transition={{ duration: 1.5, repeat: Infinity, delay: 0.6 }}>
              Disrupt
            </motion.span>
          </p>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }} className="mb-12">
          <motion.a href="https://unstop.com/o/3C4O1aP?lb=O4B2h3r" target="_blank" rel="noopener noreferrer" className="relative inline-flex items-center gap-3 px-10 py-5 font-display font-bold text-lg md:text-xl rounded-full overflow-hidden group" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            ...
            {/* Glow effect */}
            <motion.div className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity" style={{
        ...
        {/* Stats Cards */}
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8 }} className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {[
            ...
            { icon: MapPin, label: 'Venue', value: 'AITAM', color: 'from-indigo-400 to-purple-500' },
        ].map((stat, index) => (<motion.div key={stat.label} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 + index * 0.1 }} whileHover={{ scale: 1.05, y: -5 }} className="relative group">
              <div className="bg-card/50 backdrop-blur-sm border border-primary/20 rounded-xl p-4 text-center hover:border-primary/50 transition-all duration-300">
                <motion.div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity" style={{
      ...
      {/* Scroll indicator */}
      <motion.button onClick={scrollToAbout} className="absolute bottom-8 left-1/2 -translate-x-1/2 cursor-pointer" animate={{ y: [0, 10, 0] }} transition={{ duration: 2, repeat: Infinity }} whileHover={{ scale: 1.1 }}>
        <div className="flex flex-col items-center gap-2">
          ...
          <motion.div className="w-8 h-12 border-2 border-primary/50 rounded-full flex justify-center pt-2 hover:border-primary transition-colors">
            <motion.div className="w-2 h-2 bg-primary rounded-full" animate={{ y: [0, 16, 0], opacity: [1, 0.3, 1] }} transition={{ duration: 2, repeat: Infinity }}/>
          </motion.div>
        </div>
      </motion.button>

      {/* Side decorative lines */}
      <motion.div className="absolute left-8 top-1/4 bottom-1/4 w-px hidden lg:block" style={{
      ...
      <motion.div className="absolute right-8 top-1/4 bottom-1/4 w-px hidden lg:block" style={{
            background: 'linear-gradient(to bottom, transparent, hsl(195, 100%, 50% / 0.5), transparent)',
        }} initial={{ scaleY: 0 }} animate={{ scaleY: 1 }} transition={{ delay: 1, duration: 1 }}/>
    </section>);
};
