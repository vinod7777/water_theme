...
const CausticsOverlay = () => (<div className="absolute inset-0 overflow-hidden pointer-events-none z-[1]">
...
const Preloader = ({ onComplete }) => {
    ...
    return (<motion.div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center overflow-hidden" style={{
      ...
      <motion.div className="absolute left-0 right-0 bottom-0 z-[1]" style={{
      ...
      <div className="relative z-[10] flex flex-col items-center">
        ...
        <motion.div className="relative mb-6" initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.8, type: "spring", bounce: 0.4, delay: 0.1 }}>
          {/* Outer glow - more dramatic */}
          <motion.div className="absolute -inset-12 rounded-full blur-3xl" style={{ background: 'hsl(195, 100%, 50% / 0.3)' }} animate={{
            scale: [1, 1.6, 1],
            opacity: [0.2, 0.6, 0.2],
          ...
          {/* Glass water drop */}
          <motion.div className="relative w-28 h-28 md:w-36 md:h-36" animate={{
            scale: [1, 1.08, 1],
            rotate: [0, 3, -3, 0],
        }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}>
            <svg viewBox="0 0 100 120" className="w-full h-full drop-shadow-2xl">
              ...
              <path d="M50 8 C50 8 15 50 15 72 C15 92 30 108 50 108 C70 108 85 92 85 72 C85 50 50 8 50 8Z" fill="url(#dropGrad)" filter="url(#dropGlow)" stroke="hsl(195, 100%, 70% / 0.4)" strokeWidth="1"/>
              <path d="M50 15 C50 15 25 48 25 70 C25 75 27 80 30 84" fill="none" stroke="url(#dropShine)" strokeWidth="3" strokeLinecap="round"/>
            ...
            {[...Array(4)].map((_, i) => (<motion.div key={i} className="absolute rounded-full" style={{
                width: 6 + i * 2,
                height: 6 + i * 2,
