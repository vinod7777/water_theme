...
const FAQItem = ({ question, answer, isOpen, onClick, index }: FAQItemProps) => (
  ...
  >
    ...
    >
      ...
      <motion.span 
        className="text-2xl font-light shrink-0 text-primary"
...
const FAQSection = () => {
  ...
  return (
    <section className="relative py-24 overflow-hidden water-bg-effect" id="faq">
      {/* Background */}
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div>
            <motion.h3
              ...
              viewport={{ once: true }}
              className="text-2xl md:text-3xl font-display font-bold mb-8 flex items-center gap-3 text-gradient-water"
            >
