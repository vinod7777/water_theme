...
const WaterTextEffect = ({ children, id = "waterText" }: { children: React.ReactNode; id?: string }) => {
  ...
  return (
    <div className="relative flex items-center justify-center">
      {/* Expanding water ripple rings behind the text */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        {ripples.map((r) => (
          <motion.div
            ...
            initial={{ width: 40, height: 20, opacity: 0.6 }}
            animate={{
              width: [40, 500, 900],
              height: [20, 200, 400],
              opacity: [0.6, 0.3, 0],
