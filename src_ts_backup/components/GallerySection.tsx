...
const GallerySection = () => {
  ...
  return (
    <section ref={ref} className="relative py-24 overflow-hidden water-bg-effect" id="gallery">
      {/* Background */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <motion.h2 
            className="font-display text-3xl md:text-5xl font-black mb-4 text-gradient-water"
          >
            ...
            >
              ...
              <motion.div 
                className={`absolute inset-0 ${
                  index % 4 === 0 ? "bg-gradient-to-br from-primary/30 via-secondary/20 to-accent/30" :
                  ...
                  "bg-gradient-to-br from-water-cyan/30 via-water-blue/20 to-water-teal/30"
                }`}
                animate={{
                  opacity: [0.6, 0.8, 0.6],
                }}
              ...
              <motion.div 
                className="absolute top-3 left-3 w-6 h-6 border-l-2 border-t-2 border-primary/60"
                animate={{
              ...
              />
              <motion.div 
                className="absolute bottom-3 right-3 w-6 h-6 border-r-2 border-b-2 border-primary/60"
                animate={{
