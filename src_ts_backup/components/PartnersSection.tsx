...
const PartnersSection = () => {
  ...
  return (
    <section ref={ref} className="relative py-24 overflow-hidden water-bg-effect" id="partners">
      {/* Background */}
        ...
        <div className="flex flex-wrap justify-center gap-12 max-w-6xl mx-auto">
          {Object.entries(groupedPartners).map(([type, partners], catIndex) => (
            ...
            >
              {/* Category Title */}
              <motion.h3
                className="text-xl md:text-2xl font-display font-bold mb-6 text-gradient-water"
              >
                {type}
              </motion.h3>
                ...
                {partners.map((partner, index) => (
                  ...
                  >
                    ...
                    <div className="relative bg-white/95 backdrop-blur-sm rounded-xl h-24 w-28 flex items-center justify-center p-3 overflow-hidden transition-all duration-500 group-hover:shadow-2xl border border-transparent group-hover:border-primary/30">
                      ...
                      {/* Pulse ring on hover */}
                      <motion.div
                        className="absolute inset-0 rounded-xl border-2 border-primary/50 opacity-0 group-hover:opacity-100"
                        animate={{
                          scale: [1, 1.1, 1],
                          opacity: [0.5, 0, 0.5],
                        }}
